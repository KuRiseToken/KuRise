...
KuRise is the first Hyper Deflationary token on KCC.


Twitter: https://twitter.com/KuRiseToken
Telegram: https://t.me/KuRiseToken

Main features are
    
1) 2% tax is collected and distributed to holders for HODLing
2) 8% buyback and marketing tax is collected and 2% of it is sent for marketing fund and othe 6% is used to buyback the tokens
...
contract KuRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x51A974fff347A2fAdDF804A1D107C132eFd66f7e); // Marketing Address
    ...
    string private _name = "KuRise";
    string private _symbol = "KURISE";
    ...
    constructor () {
        ...
        /*IKoffeeSwapRouter _router = IKoffeeSwapRouter(0xc0fFee0000C824D24E0F280f1e4D21152625742b);
        pair = IKoffeeSwapFactory(_router.factory())
